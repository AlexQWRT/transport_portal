    ...
    <div class="row">
      ...
      <div class="col-md-6 col-sm-8">
        <div class="profile_wrap">
          <h5 class="uppercase underline">Общие настройки</h5>
          <?php  
         if($msg){?><div class="succWrap"><strong>УСПЕХ</strong>:<?php echo htmlentities($msg); ?> </div><?php }?>
          <form  method="post">
           <div class="form-group">
            ...
            <div class="form-group">
              <label class="control-label">Последнее обновление в -</label>
            ...
            <div class="form-group">
              <label class="control-label">Тел номер</label>
            ...
            <div class="form-group">
              <label class="control-label">Дата рождения&nbsp;(dd/mm/yyyy)</label>
            ...
            <div class="form-group">
              <button type="submit" name="updateprofile" class="btn">Сохраить изменения <span class="angle_arrow"><i class="fa fa-angle-right" aria-hidden="true"></i></span></button>
            </div>
          </form>
        </div>
      </div>
