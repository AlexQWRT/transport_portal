        ...
        <aside class="col-md-3 col-md-pull-9">
          <div class="sidebar_widget">
            <div class="widget_heading">
              <h5><i class="fa fa-filter" aria-hidden="true"></i> Поиск ТС </h5>
            </div>
              ...
              <form action="search-carresult.php" method="post">
                ...
                <div class="form-group select">
                  <select class="form-control" name="fueltype">
                    <option>Выберите тип топлива</option>
                ...
                <div class="form-group">
                  <button type="submit" class="btn btn-block"><i class="fa fa-search" aria-hidden="true"></i> Поиск</button>
                </div>
              </form>
            </div>
          </div>
          ...
          <div class="sidebar_widget">
            <div class="widget_heading">
              <h5><i class="fa fa-car" aria-hidden="true"></i>Недавно добавленные ТС</h5>
            </div>
