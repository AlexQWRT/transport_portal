...
$cnt=$query->rowCount();
?>
<p><span><?php echo htmlentities($cnt);?> записей</span></p>
</div>
</div>
...
{  ?>
        <div class="product-listing-m gray-bg">
          ...
          <div class="product-listing-content">
            ...
            <p class="list-price">BYN&nbsp<?php echo htmlentities($result->PricePerDay);?> в сутки</p>
            <ul>
            ...
            <a href="vehical-details.php?vhid=<?php echo htmlentities($result->id);?>" class="btn">Просмотр деталей <span class="angle_arrow"><i class="fa fa-angle-right" aria-hidden="true"></i></span></a>
          </div>
        </div>
      <?php }} ?>
         </div>
      ...
      <aside class="col-md-3 col-md-pull-9">
        <div class="sidebar_widget">
          <div class="widget_heading">
            <h5><i class="fa fa-filter" aria-hidden="true"></i> Найди свое ТС </h5>
          </div>
          <div class="sidebar_filter">
          <form action="search-carresult.php" method="post">
              <div class="form-group select">
              <select class="form-control" name="brand">
              <option>Выбрать тип ТС</option>
...
<?php }} ?>
              ...
              <option>Выбрать тип топлива</option>
...
<option value="CNG">Газ</option>
              ...
              <div class="form-group">
                <button type="submit" class="btn btn-block"><i class="fa fa-search" aria-hidden="true"></i> Поиск ТС</button>
              </div>
            </form>
          </div>
        </div>
        ...
        <div class="sidebar_widget">
          <div class="widget_heading">
            <h5><i class="fa fa-car" aria-hidden="true"></i> Недавно добавленные</h5>
          </div>
...
{  ?>
              ...
              <li class="gray-bg">
                ...
                <div class="recent_post_title"> <a href="vehical-details.php?vhid=<?php echo htmlentities($result->id);?>"><?php echo htmlentities($result->BrandName);?> , <?php echo htmlentities($result->VehiclesTitle);?></a>
                  <p class="widget_price">BYN&nbsp<?php echo htmlentities($result->PricePerDay);?> в сутки</p>
                </div>
              </li>
              <?php }} ?>
