              ...
              <div class="listing_more_info">
                <div class="listing_detail_wrap">
                  ...
                  <ul class="nav nav-tabs gray-bg" role="tablist">
                    <li role="presentation" class="active"><a href="#vehicle-overview " aria-controls="vehicle-overview" role="tab" data-toggle="tab">Обзор ТС </a></li>

                    <li role="presentation"><a href="#accessories" aria-controls="accessories" role="tab" data-toggle="tab">Аксессуары</a></li>
                  </ul>
                    ...
                    <div role="tabpanel" class="tab-pane" id="accessories">
                      ...
                      <table>
                        ...
                        <tbody>
                          ...
                          <tr>
                            <td>Антиблокировочная система</td>
                          ...
                          <tr>
                            ...
                            <td>Электрические стеклоподъемники</td>
                          ...
                          <tr>
                            <td>Дверные замки с электроприводом</td>
                          ...
                          <tr>
                            <td>Система помощи при торможении</td>
          ...
          <?php }
            ...
            <aside class="col-md-3">
              ...
              <div class="share_vehicle">
                <p>Делиться: <a href="#"><i class="fa fa-facebook-square" aria-hidden="true"></i></a> <a href="#"><i class="fa fa-twitter-square" aria-hidden="true"></i></a> <a href="#"><i class="fa fa-linkedin-square" aria-hidden="true"></i></a> <a href="#"><i class="fa fa-google-plus-square" aria-hidden="true"></i></a> </p>
              </div>
              <div class="sidebar_widget">
                <div class="widget_heading">
                  <h5><i class="fa fa-envelope" aria-hidden="true"></i>Забронировать</h5>
                </div>
                <form method="post">
                  <div class="form-group">
                    <input type="text" class="form-control" name="fromdate" placeholder="С даты(dd/mm/yyyy)" required>
                  </div>
                  <div class="form-group">
                    <input type="text" class="form-control" name="todate" placeholder="По дату(dd/mm/yyyy)" required>
                  </div>
                  <div class="form-group">
                  ...
                  <?php } else { ?>
                    <a href="#loginform" class="btn btn-xs uppercase" data-toggle="modal" data-dismiss="modal">Войти для брони</a>
                  ...
                  <div class="col-md-3 grid_listing">
                    <div class="product-listing-m gray-bg">
                      ...
                      <div class="product-listing-content">
                        ...
                        <p class="list-price">BYN&nbsp<?php echo htmlentities($result->PricePerDay); ?></p>
