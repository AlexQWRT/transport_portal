...
$query -> execute();
$msg="Запись о транспортном средстве успешно удалена";
}
...
<head>
	...
	<title>Car Rental Portal |Admin Manage Type Vehicles</title>
			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<h2 class="page-title">Управление транспортными средствами</h2>

						<!-- Zero Configuration Table -->
						<div class="panel panel-default">
							<div class="panel-heading">Детали транспортного средства</div>
...
<a href="manage-vehicles.php?del=<?php echo $result->id;?>" onclick="return confirm('Вы хотите удалить');"><i class="fa fa-close"></i></a></td>
										</tr>
										<?php $cnt=$cnt+1; }} ?>
